...
Running this example, you will see the LED/RGB signal with a duty cycle of 50%.

![PWM](/sources/ota_led_basic/output_examples.jpg)
...
For any technical queries, please open an [issue](https://github.com/BlessedChild/TimeTree/issues) on GitHub. We will get back to you soon.
